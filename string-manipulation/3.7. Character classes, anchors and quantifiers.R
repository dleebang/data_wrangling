...
# that match and some that do not. This allows checking for two types of errors:
# failing to match and matching incorrectly
# 
# Square brackets define character classes: groups of chars that count as matching
# the pattern. You can use ranges to define char classes such as [0-9] for digits
