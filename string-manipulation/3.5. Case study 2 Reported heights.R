...
# height information but in the wrong format, which we can extract with string processing
# 
# When there are both text and numeric entries in a column, the column will be a
# character vector. Converting this column to numeric will result in NAs for 
# some entries
# 
