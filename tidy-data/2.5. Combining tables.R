...
# 
# inner_join() only keeps rows that have information in both tables (intersection)
# 
# full_join() keeps all rows from both tables (union)
# 
# semi_join() keeps part of first table for which we have information in the second
# 
